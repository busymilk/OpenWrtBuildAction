...
sed -i "s/DEFAULT_PACKAGES:=/DEFAULT_PACKAGES:=luci-app-homebox luci-app-netspeedtest luci-app-smartdns luci-app-speedtest-web luci-app-store luci-app-watchcat luci-app-advancedplus luci-app-firewall luci-app-package-manager luci-app-upnp luci-app-syscontrol \
